...
def test_conjugate_gradient_op_rejects_differentiable_initial_value(implicit_backward: bool) -> None:
    ...
    with pytest.raises(ValueError, match='constant warm start'):
