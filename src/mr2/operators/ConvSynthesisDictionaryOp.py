"""Convolutional Synthesis Dictionary Operator."""
...
class ConvSynthesisDictionaryOp(LinearOperator):
    """Convolutional Synthesis Dictionary Operator."""
    ...
    def __init__(
        ...
        Note that :math:`\mathrm{conv}` actually performs a cross-correlation matching torch's convolution
        implementation.
    ...
    def forward(self, x: torch.Tensor) -> tuple[torch.Tensor,]:
        ...
        .. note::
            Prefer calling the instance of the ConvSynthesisDictionaryOp operator as ``operator(x)`` over
