...
from mr2.utils.slice_profiles import SliceSmoothedRectangular
from mr2.utils.typing import NestedSequence
...
class SliceProjectionOp(LinearOperator):
    ...
    def __init__(
        ...
        slice_profile
            ...
            numpy array of functions. See `mr2.utils.slice_profiles` for examples.
    ...
    def __call__(self, x: Tensor) -> tuple[Tensor]:
        ...
        at initialization. It samples the input 3D volume to generate a 2D slice.
    ...
    def projection_matrix(
        ...
        slice_function
            Function that describes the slice profile. See `mr2.utils.slice_profiles` for examples.
        rotation_center
